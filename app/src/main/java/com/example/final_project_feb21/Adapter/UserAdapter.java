...
import com.example.final_project_feb21.MainActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ImageViewHolder> {
    ...
    public UserAdapter(Context mcontext, List<Userr> musers,boolean isFragment) {
    ...
    public void onBindViewHolder(@NonNull final UserAdapter.ImageViewHolder holder, int position) {
        ...
        final Userr User = musers.get(position);
